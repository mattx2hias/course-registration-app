...
public class StudentDaoTests {
    ...
    void readEnrolledCoursesTest() {
        Assertions.assertEquals("HOW111", sDao.readEnrolledCourses(7290).get(0));
    }

    @Test
    void isEnrolled() {
        Assertions.assertTrue(sDao.isEnrolled(7290, "HOW111"));
    }

    @Test
    void registerForCourseTest() {
        Assertions.assertTrue(sDao.registerForCourse(7290, "how111"));
    }

    @Test
    void cancelRegistrationTest() {
        Assertions.assertTrue(sDao.cancelRegistration(7290, "how111"));
    }
}
